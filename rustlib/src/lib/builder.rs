...
fn build_page(
	...
	file.write(b"<meta name='viewport' content='width=device-width, initial-scale=1'>")?;
...
fn build_footer(
	...
	if terms.name == "home" {
		...
		file.write(b"<div>")?;
		file.write(b"<div class='footer-mobile-index'><a href='/index.html'>~</a></div>")?;
		file.write(b"<lc><div>")?;
		file.write_fmt(format_args!(
		...
		file.write(b"</div></lc>")?;
		file.write(b"<rc>")?;
		file.write(b"<p>this website was generated by <a href='/site/skiff.html'> skiff</a>")?;
		file.write(b"<div class='footer-extlink'>")?;
		file.write_fmt(format_args!(
			"<div class='footer-cc'>{}</div>",
			"BY-NC-SA 4.0"
		))?;
		file.write(b"<a target='_blank' href='https://creativecommons.org/licenses/by-nc-sa/4.0'><img src='../media/icon/cc.svg'/></a>")?;
		file.write(b"<a target='_blank' href='https://github.com/karnpapon'><img src='../media/icon/github.png' alt='github'/></a>")?;
		file.write(b"</div>")?;
		file.write(b"</rc>")?;
		file.write(b"</div>")?;
		file.write(b"</div>")?;
